...
Ext.onReady(function(){
    if(Ext.ClassManager.isCreated('Ext.Updater')){
        Ext.Updater.defaults.indicatorText = '<div class="loading-indicator">加载中...</div>';
    }

    if(Ext.ClassManager.isCreated('Ext.view.View')){
       Ext.view.View.prototype.emptyText = "";
    }

    if(Ext.ClassManager.isCreated('Ext.grid.Panel')){
       Ext.grid.Panel.prototype.ddText = "选择了 {0} 行";
    }

    if(Ext.ClassManager.isCreated('Ext.TabPanelItem')){
       Ext.TabPanelItem.prototype.closeText = "关闭此标签";
    }

    if(Ext.ClassManager.isCreated('Ext.form.field.Base')){
    ...
    if(Ext.ClassManager.isCreated('Ext.Date')){
        Ext.Date.monthNames = [
           "一月",
           "二月",
           "三月",
    ...
    if(Ext.ClassManager.isCreated('Ext.MessageBox')){
    ...
    if(Ext.ClassManager.isCreated('Ext.util.Format')){
    ...
    if(Ext.ClassManager.isCreated('Ext.picker.Date')){
    ...
    if(Ext.ClassManager.isCreated('Ext.picker.Month')) {
    ...
    if(Ext.ClassManager.isCreated('Ext.toolbar.Paging')){
    ...
    if(Ext.ClassManager.isCreated('Ext.form.field.Text')){
    ...
    if(Ext.ClassManager.isCreated('Ext.form.field.Number')){
    ...
    if(Ext.ClassManager.isCreated('Ext.form.field.Date')){
    ...
    if(Ext.ClassManager.isCreated('Ext.form.field.ComboBox')){
    ...
    if(Ext.ClassManager.isCreated('Ext.form.field.VTypes')){
    ...
    if(Ext.ClassManager.isCreated('Ext.form.field.HtmlEditor')){
    ...
    if(Ext.ClassManager.isCreated('Ext.grid.header.Container')){
    ...
    if(Ext.ClassManager.isCreated('Ext.grid.PropertyColumnModel')){
