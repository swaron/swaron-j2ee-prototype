Ext.define('Ext.ux2.datetime.DateTimeField', {
	...
	initComponent : function() {
		this.callParent();
		this.format = this.dateFormat + ' ' + this.timeFormat + ' T';
	},
	onTimechange : function(picker ,newVal) {
		var me = this;
		console.log('set value to '+ newVal)
		me.setValue(newVal);
//		me.fireEvent('select', me, newVal);
	},
	// overwrite
