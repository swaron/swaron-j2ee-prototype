 ...
 * @author Mike Wiesner
 * @since 1.0
 * @version $Id: KerberosServiceRequestToken.java 57 2009-12-21 16:18:24Z mwiesner $
...
public class KerberosServiceRequestToken extends AbstractAuthenticationToken {
     ...
     * @param collection the authorities which are granted to the user
     * @param token the Kerberos/SPNEGO token
     * @see UserDetails
     */
    public KerberosServiceRequestToken(Object principal, Collection<? extends GrantedAuthority> collection, byte[] token) {
        super(collection);
        this.token = token;
